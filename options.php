...
$arAllOptions = array(
    ...
    array("active", Loc::getMessage('MODULE_TRIGGMINE_ACTIVE'), "", array("checkbox")),
    array("id", Loc::getMessage('MODULE_TRIGGMINE_KEY'), "", array("text", 20)),
    array("note" => Loc::getMessage('MODULE_TRIGGMINE_KEY')),
    array("ignore_admin", Loc::getMessage('MODULE_TRIGGMINE_IGNORE_ADMIN'), "", array("checkbox"))
);
